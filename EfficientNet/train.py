...
from model_v2 import efficientnetv2_s
...
def main():
    ...
    model = efficientnetv2_s(num_classes=len(class_indices))
    ...
    callbacks = [tf.keras.callbacks.ModelCheckpoint(filepath='./weights/efficient_v2_s{}.h5'.format(epochs),
                                                    save_best_only=True,
